FargoCoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/FargoCoin/bitcoin-0.8.4/
...
code, causing the FargoCoin-Qt or bitcoind process to crash.
...
Linux: clicking on fargocoin: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of FargoCoin against Boost versions 1.50-1.52.
