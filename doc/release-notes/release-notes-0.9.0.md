FargoCoin Core version 0.9.0 is now available from:
...
earlier versions of FargoCoin, then run the installer (on Windows) or just copy
over /Applications/FargoCoin-Qt (on Mac) or bitcoind/fargocoin-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the FargoCoin
...
Rebranding to FargoCoin Core
---------------------------

To reduce confusion between FargoCoin-the-network and FargoCoin-the-software we
have renamed the reference client to FargoCoin Core.
...
Using the standard "./autogen.sh; ./configure; make" to build FargoCoin-Qt and
...
- Rebrand to `FargoCoin Core`
- Move initialization/shutdown to a thread. This prevents "Not responding"
  messages during startup. Also show a window during shutdown.
- Don't regenerate autostart link on every client startup
- Show and store message of normal fargocoin:URI
- Fix richtext detection hang issue on very old Qt versions
- OS X: Make use of the 10.8+ user notification center to display Growl-like 
  notifications
- OS X: Added NSHighResolutionCapable flag to Info.plist for better font
  rendering on Retina displays.
- OS X: Fix fargocoin-qt startup crash when clicking dock icon
- Linux: Fix Gnome fargocoin: URI handler
