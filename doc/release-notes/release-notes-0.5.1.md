FargoCoin version 0.5.1 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/FargoCoin/bitcoin-0.5.1/
...
Improved searching in addresses and labels in fargocoin-qt.
