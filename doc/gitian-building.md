...
*Setup instructions for a Gitian build of FargoCoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the FargoCoin
...
- [Building FargoCoin](#building-bitcoin)
...
To build FargoCoin (for Linux, OS X and Windows) just follow the steps under 'perform
