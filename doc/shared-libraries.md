...
The purpose of this library is to make the verification functionality that is critical to FargoCoin's consensus available to other applications, e.g. to language bindings.
...
- [NFargoCoin](https://github.com/NicolasDorier/NFargoCoin/blob/master/NFargoCoin/Script.cs#L814) (.NET Bindings)
