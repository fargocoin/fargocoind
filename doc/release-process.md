...
###FargoCoin maintainers/release engineers, update (commit) version in sources
...
###Build and sign FargoCoin Core for Linux, Windows, and OS X:
...
- Update bitcoin.org version
  ...
  - First, check to see if the FargoCoin.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the FargoCoin.org release
...
- Announce the release:
  ...
  - FargoCoin-development mailing list

  - Update title of #bitcoin on Freenode IRC

  - Optionally reddit /r/FargoCoin, ... but this will usually sort out itself
