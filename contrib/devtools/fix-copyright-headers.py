...
// Copyright (c) 2009-2012 The FargoCoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The FargoCoin/$1-%s The FargoCoin/' %s"
REGEX_CURRENT= re.compile("%s The FargoCoin" % year)
