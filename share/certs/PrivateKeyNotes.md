...
unlocked to sign the FargoCoin-Qt.app bundle.
...
allowing somebody to distribute a FargoCoin-Qt.app or fargocoin-qt-setup.exe with a valid
...
that the fargocoin-qt.exe file inside the installer had not been tampered with.
