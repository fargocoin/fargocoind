// Copyright (c) 2011-2013 The FargoCoin developers
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatFargoCoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + FargoCoinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatFargoCoinURI(info));
}
