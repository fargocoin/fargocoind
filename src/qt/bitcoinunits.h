...
#ifndef E_DINAR_QT_BITCOINUNITS_H
#define E_DINAR_QT_BITCOINUNITS_H
...
/** FargoCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FargoCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FargoCoinUnits(QObject *parent);
...
typedef FargoCoinUnits::Unit FargoCoinUnit;

#endif // E_DINAR_QT_BITCOINUNITS_H
